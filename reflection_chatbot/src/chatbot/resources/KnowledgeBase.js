...
export const KnowledgeBase = {
  ...
  stakeholders: {
    ...
    initialChatMessage: `Stakeholders are anyone interested in your project and its outcomes. Can you think of at least three people who might be impacted by your project?`,
  ...
  positiveImpacts: {
    ...
    content: {
      ...
      example: [
        ...
        `Teenagers who have difficulty getting access to good health care could benefit the most. This would have a high impact.`,
        `Feel free to ask if you would like ideas for your project.`
      ],
      ideas: [
        `Chatbots for mental health offer convenience, space to talk about problems anonymously, and an interactive experience.`,
...
export const AutoKnowledgeBase = {
  description: {
    ...
    content: {
      ...
      example: [
        `I can share an example. Let's say that I am making a self-driving vehicle that benefits low-income communities.`,
        `This would be my description: This project helps make transportation more affordable and easier to access in these communities by offering rides from people's homes to transport hubs, hospitals, and grocery stores.`,
        `What are important points for your project description?`
      ],
      ideas: [
        `Some problems that self-driving vehicles can address are on-demand transportation, more accessible transportation for people with disabilities, delivering materials and goods, and automating tasks in industries like agriculture.`,
        `Would you like some more ideas?`,
      ],
    },
  },
  stakeholders: {
    ...
    content: {
      ...
      example: [
        `OK here's an example. Let's say that I am making a self-driving vehicle that benefits low-income communities.`,
        `Here are three key stakeholders: people who use the roads all the time, people who don't drive, and people with less access to technology.`,
        `The most vulnerable stakeholders are people who don't know a lot about technology since they might struggle with a new high-tech transportation system.`,
        `Feel free to ask if you would like ideas for your project.`
      ],
      vulnerable: [
        `Vulnerable stakeholders are the people who are most at risk and have the least control over the algorithm's impact on themselves.`,
  ...
  positiveImpacts: {
    ...
    content: {
      ...
      example: [
        `Here's an example. Let's say that I am making a self-driving vehicle that benefits low-income communities.`,
        `One benefit of this new system is that it can make it easier for people to access transportaiton.`,
        ` People who cannot drive themselves or who don't have access to cars would get the most benefit. This would have a high impact.`,
        `Feel free to ask if you would like ideas for your project.`
      ],
      ideas: [
        `Some common benefits of self-driving cars are that they can improve safety and traffic flow, improve transportation access, save poeple time, and create new jobs. That's * if * the system is designed well.`,
        `Do some of these benefits apply to your project, or would you like more ideas?`
      ],
      stakeholders: [
        `It is important to use design justice to make sure that the benefits of tech are equitably shared.`,
  ...
  negativeImpacts: {
    ...
    content: {
      ...
      example: [
        `Check out this example. Let's say that I am making a self-driving vehicle that benefits low-income communities.`,
        `The potential harms are: the self-driving vehicles might be dangerous depending on what neighborhood they are used in, we also should be careful about taking people's jobs and making sure people who are not as comfortable with technology are included.`,
        `It will be important to test the vehicles a lot, especially at the beginning, making sure they are safe and everyone can use them. This would be a pretty high risk project which would need a lot of oversight.`,
        `Does this seem similar to your project idea?`
      ],
      ideas: [
